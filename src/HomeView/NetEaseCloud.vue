...
<div :class="{dark:switchCheckStatus}">
  <div class="bg-[#f5f5f5] text-[#000] dark:bg-[#000] dark:text-[#fff]">
    ...
    <Drawer :visible.sync="drawerVisible" direction="btt" width="100vw">
        <div class="flex items-center justify-between border-b-[1px] border-[#ccc]">
    ...
    <Drawer :visible.sync="drawerVisiblel" direction="ltr" width="83.61vw">
        <div class="h-[490vw] bg-[#f5f5f5] text-[#000] dark:bg-[#000] dark:text-[#000]">
            <div class="w-[75.09vw] ml-[4.35vw] ">
                <div class="flex justify-between items-center pt-[4.63vw] bg-[#f5f5f5] text-[#000] dark:bg-[#000] dark:text-[#fff]">
                        <div class="flex items-center">
                ...
                <div class="w-[75.09vw] h-[31.67vw] bg-[#564b4a] rounded-[10px] mt-[6.2vw]">
                ...
                <div class="w-[75vw] h-[43.76vw] bg-[#fff] mt-[4.36vw] rounded-[8px]">
                ...
                <div class="w-[75vw] h-[111.33vw] bg-[#fff] mt-[4.44vw] rounded-[8px]">
                ...
                <div class="w-[75vw] h-[138.02vw] bg-[#fff] mt-[4.44vw] rounded-[8px]">
                ...
                <div class="w-[75vw] h-[111.11vw] bg-[#fff] mt-[4.63vw] rounded-[8px]">
                    <div class="ml-[4.63vw] pb-[4.81vw] pt-[4.54vw] flex items-center justify-between border-b border-[#e6e6e6]">
                        <div class="flex items-center">
                ...
                <div class="w-[75vw] mt-[4.54vw] h-[13.52vw] bg-[#fff] rounded-[8px] ">
                    <p class="text-center text-[12px] text-[red] leading-[13.52vw]">退出登录/关闭</p>
                </div>
            </div>
        </div>
    </Drawer>
